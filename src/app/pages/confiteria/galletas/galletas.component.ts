...
import { GalletasService } from '../../../services/galletas.service';
@Component({
...
export class GalletasComponent implements OnInit{
    ...
    selectedCategory: string | null = 'Galletas';
    marcas: any[] = [];
    marcasCantidad: any[] = [];
    tiposConfiteria:any[] =[];
    categorias: any[] = [];
    ...
    url='http://localhost:3000/uploads'; 
      ...
      constructor( private confiteriaService: ConfiteriaService,private galletaService : GalletasService,  private route: ActivatedRoute, private router: Router){}
        ngOnInit(): void {
    ...
    selectCategory(nombreCategoria: string): void {
      ...
      } else if (nombreCategoria === 'Galletas') {
