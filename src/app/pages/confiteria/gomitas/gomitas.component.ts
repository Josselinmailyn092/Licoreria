...
@Component({
  ...
  styleUrl: './gomitas.component.css'
})
export class GomitasComponent implements OnInit{
  selectedCategory: string | null = 'Gomitas';
  marcas: any[] = [];
  marcasCantidad: any[] = [];
  tiposConfiteria:any[] =[];
  categorias: any[] = [];
  ...
  selectCategory(nombreCategoria: string): void {
    ...
    } else if (nombreCategoria === 'Gomitas') {
