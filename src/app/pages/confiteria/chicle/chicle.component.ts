...
@Component({
  ...
  styleUrl: './chicle.component.css'
})
export class ChicleComponent {

  selectedCategory: string | null = 'Chicle';
  marcas: any[] = [];
  marcasCantidad: any[] = [];
  tiposConfiteria:any[] =[];
  categorias: any[] = [];
  ...
  url='/uploads';
    ...
    this.chicleService.getCountMarcasChicle().subscribe((data) => {
  ...
  selectCategory(nombreCategoria: string): void {
    ...
    } else if (nombreCategoria === 'Chicle') {
