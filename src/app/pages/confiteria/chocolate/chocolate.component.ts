...
@Component({
  ...
  styleUrl: './chocolate.component.css'
})
export class ChocolateComponent  implements OnInit{


  selectedCategory: string | null = 'Chocolates';
  marcas: any[] = [];
  marcasCantidad: any[] = [];
  tiposConfiteria:any[] =[];
  categorias: any[] = [];
  ...
  url='http://localhost:3000/uploads'; 
    ...
    this.chocolateService.getCountMarcasChocolate().subscribe((data) => {
  ...
  selectCategory(nombreCategoria: string): void {
    ...
    } else if (nombreCategoria === 'Chocolates') {
