...
private cargarDatosIniciales(): void {
    forkJoin({
      ...
      marcas: this.marcaService.obtenerMarcasPorCategoria('Vinos'),
      marcasCantidad: this.marcaService.obtenerTotalProductosPorMarcasDeCategoria('Vinos'),
      presentaciones: this.presentacionService.obtenerPresentacionesPorCategoria('Vinos'),
      presentacionesCantidad: this.presentacionService.obtenerTotalProductosPorPresentacionesDeCategoria('Vinos'),
      productos: this.productosService.obtenerProductos({ categoria: 'Vinos' })
    }).subscribe({
