...
import { ProductoVinosService } from '../../../services/productoVinos.service';
...
export class VinosComponent implements OnInit {
  selectedCategory: string | null = 'Vinos';
  marcas: any[] = [];
  marcasCantidad: any[] = [];
  tiposLicores: any[] = [];
  categorias: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.productoVinosService.getPresentacionesVinos().subscribe((data) => {
      this.presentaciones = data;
    });

    // Cantidad de presentaciones disponibles
    this.productoVinosService.getPresentacionesVinosCount().subscribe((data) => {
