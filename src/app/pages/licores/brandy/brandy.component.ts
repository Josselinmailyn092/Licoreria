...
import { MarcasService } from '../../../services/marcas.service';@Component({
  selector: 'app-brandy',
...
private cargarDatosIniciales(): void {
    forkJoin({
      ...
      marcas: this.marcaService.obtenerMarcasPorCategoria('Brandy'),
      marcasCantidad: this.marcaService.obtenerTotalProductosPorMarcasDeCategoria('Brandy'),
      presentaciones: this.presentacionService.obtenerPresentacionesPorCategoria('Brandy'),
      presentacionesCantidad: this.presentacionService.obtenerTotalProductosPorPresentacionesDeCategoria('Brandy'),
      productos: this.productosService.obtenerProductos({ categoria: 'Brandy' })
    }).subscribe({
