...
import { ProductoTequilaService } from '../../../services/productoTequila.service';
...
export class TequilaComponent implements OnInit {
  selectedCategory: string | null = 'Tequila';
  marcas: any[] = [];
  marcasCantidad: any[] = [];
  tiposLicores: any[] = [];
  categorias: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.productoTequilaService.getMarcasTequila().subscribe((data) => {
      this.marcas = data.map((marca) => marca.nombreMarca); // Indica solo los nombres de las marcas
    });

    // Contar cantidad de marcas disponibles
    this.productoTequilaService.getCountMarcasTequila().subscribe((data) => {
    ...
    this.productoTequilaService.getPresentacionesTequila().subscribe((data) => {
      this.presentaciones = data;
    });

    // Cantidad de presentaciones disponibles
    this.productoTequilaService.getPresentacionesTequilaCount().subscribe((data) => {
...
// }
  ...
  selectCategory(nombreCategoria: string): void {
    ...
    } else if (nombreCategoria === 'Tequila') {
