...
private cargarDatosIniciales(): void {
    forkJoin({
      ...
      marcas: this.marcaService.obtenerMarcasPorCategoria('Tequila'),
      marcasCantidad: this.marcaService.obtenerTotalProductosPorMarcasDeCategoria('Tequila'),
      presentaciones: this.presentacionService.obtenerPresentacionesPorCategoria('Tequila'),
      presentacionesCantidad: this.presentacionService.obtenerTotalProductosPorPresentacionesDeCategoria('Tequila'),
      productos: this.productosService.obtenerProductos({ categoria: 'Tequila' })
    }).subscribe({
