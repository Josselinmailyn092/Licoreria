...
private cargarDatosIniciales(): void {
    forkJoin({
      ...
      marcas: this.marcaService.obtenerMarcasPorCategoria('Vodka'),
      marcasCantidad: this.marcaService.obtenerTotalProductosPorMarcasDeCategoria('Vodka'),
      presentaciones: this.presentacionService.obtenerPresentacionesPorCategoria('Vodka'),
      presentacionesCantidad: this.presentacionService.obtenerTotalProductosPorPresentacionesDeCategoria('Vodka'),
      productos: this.productosService.obtenerProductos({ categoria: 'Vodka' })
    }).subscribe({
